...
__C.MODEL.ENCODER_FORECASTER.RNN_BLOCKS = OrderedEasyDict()    # Define the RNN blocks for the encoder RNN
...
__C.MODEL.DECONVBASELINE = OrderedEasyDict()
...
__C.MODEL.DECONVBASELINE.COMPAT = OrderedEasyDict()  # Compatibility flags to recover behavior of previous versions
...
__C.MODEL.TRAIN = OrderedEasyDict()
...
__C.MODEL.TEST = OrderedEasyDict()
...
__C.MODEL.TEST.ONLINE = OrderedEasyDict()
