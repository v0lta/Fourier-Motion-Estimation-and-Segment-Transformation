...
import math
import os
from moving_mnist_pp.config import cfg
...
class MovingMNISTAdvancedIterator(object):
    ...
    def __init__(self,
                 ...
                 initial_velocity_range=(1.0, 3.6),
                 acceleration_range=(0.0, 0.0),
                 scale_variation_range=(1., 1.),  # (1 / 1.1, 1.1),
                 rotation_angle_range=(0, 0),  # (-30, 30),
                 global_rotation_angle_range=(0, 0),  # (-30, 30),
                 illumination_factor_range=(1.0, 1.0),
                 period=5,
                 global_rotation_prob=0.0,  # 0.5,
                 index_range=(0, 40000)):
        """
        Parameters
        ----------
